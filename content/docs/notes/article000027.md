...
Is correlating finding logs and drills down for finding root-cause.

From security hub console:

Finding
![](https://d2908q01vomqb2.cloudfront.net/da4b9237bacccdf19c0760cab7aec4a8359010b0/2023/05/05/amazon-detective-security-hub-findings-1024x628.png)


Traffic associated with finding, by date
![](https://s3.eu-central-1.amazonaws.com/alf-digital-wiki-pics/sharex/SE3GAgIn6E.png)


## AWS Security Hub

Is an aggregator of findings, nothing more.

See
<https://aws.amazon.com/blogs/security/three-recurring-security-hub-usage-patterns-and-how-to-deploy-them>
...
Allows Security-partners to 
- integrate with AWS account,
- access logs, send results

![](https://s3.eu-central-1.amazonaws.com/alf-digital-wiki-pics/sharex/189TLucsgN.png)

![](https://s3.eu-central-1.amazonaws.com/alf-digital-wiki-pics/sharex/q15WSudCdf.png)



## AWS GuardDuty

![](https://s3.eu-central-1.amazonaws.com/alf-digital-wiki-pics/sharex/DPKkxJywqA.png)

![](https://d2908q01vomqb2.cloudfront.net/da4b9237bacccdf19c0760cab7aec4a8359010b0/2022/05/20/guardduty-malware-protection-findings.png)
